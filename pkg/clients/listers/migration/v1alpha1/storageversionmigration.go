...
type StorageVersionMigrationLister interface {
	...
	List(selector labels.Selector) (ret []*migrationv1alpha1.StorageVersionMigration, err error)
	// Get retrieves the StorageVersionMigration from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(name string) (*migrationv1alpha1.StorageVersionMigration, error)
...
type storageVersionMigrationLister struct {
	listers.ResourceIndexer[*migrationv1alpha1.StorageVersionMigration]
}
...
func NewStorageVersionMigrationLister(indexer cache.Indexer) StorageVersionMigrationLister {
	return &storageVersionMigrationLister{listers.New[*migrationv1alpha1.StorageVersionMigration](indexer, migrationv1alpha1.Resource("storageversionmigration"))}
}
