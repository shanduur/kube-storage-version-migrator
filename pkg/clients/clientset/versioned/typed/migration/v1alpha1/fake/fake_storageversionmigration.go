...
type fakeStorageVersionMigrations struct {
	*gentype.FakeClientWithList[*v1alpha1.StorageVersionMigration, *v1alpha1.StorageVersionMigrationList]
	Fake *FakeMigrationV1alpha1
}

func newFakeStorageVersionMigrations(fake *FakeMigrationV1alpha1) migrationv1alpha1.StorageVersionMigrationInterface {
	return &fakeStorageVersionMigrations{
		gentype.NewFakeClientWithList[*v1alpha1.StorageVersionMigration, *v1alpha1.StorageVersionMigrationList](
			fake.Fake,
			"",
